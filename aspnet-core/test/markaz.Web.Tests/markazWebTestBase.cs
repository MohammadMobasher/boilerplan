...
{
    public abstract class markazWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static markazWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(markazWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<markazDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<markazDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<markazDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<markazDbContext, Task<T>> func)
        {
            T result;
